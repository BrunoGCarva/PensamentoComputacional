...
class Sistemainvestimento:
    ...
    def configurar_tela_principal(self):
        ...
        titulo = tk.Label(frame_principal, text="Investfácil", font=("Arial", 24, "bold"))
    ...
    def configurar_tela_perfil(self):
        ...
        label_info = tk.Label(frame_perfil, text="ME ARRUMA AQUI PLS)", font=("Arial", 10))
    ...
    def configurar_tela_investimento(self):
        ...
        btn_imovel1 = tk.Button(frame_investimento, text="Imóvel 1 - AIIII", width=30, command=lambda: self.mostrar_tela("tela_imovel1"))
        btn_imovel1.pack(pady=10, padx=20)

        btn_imovel2 = tk.Button(frame_investimento, text="Imóvel 2 - IAAAAAAA", width=30, command=lambda: self.mostrar_tela("tela_imovel2"))
    ...
    def configurar_tela_imovel1(self):
        ...
        titulo = tk.Label(frame_imovel1, text="CANSEI", font=("Arial", 16, "bold"))
        titulo.pack(pady=10)

        descricao = tk.Label(frame_imovel1, text="AI SEI LA DAVI ARRUMAAAAAAA.", justify="center")
    ...
    def configurar_tela_imovel2(self):
        ...
        titulo = tk.Label(frame_imovel2, text="HIHIHI", font=("Arial", 16, "bold"))
        titulo.pack(pady=10)

        descricao = tk.Label(frame_imovel2, text="É MUITO CREMOSO", justify="center")
        descricao.pack(pady=10, padx=20)
    ...
    def configurar_tela_listar_imovel1(self):
        ...
        # NINGUEM SABE COMO TA A MENTE DO PALHAÇU
        semanas_imovel1 = [
    ...
    def configurar_tela_listar_imovel2(self):
        ...
        semanas_imovel2 = [
            ('28', '12/07 - 19/07 (Alta Temporada)', '35.000,00'),
            ('29', '19/07 - 26/07 (Alta Temporada)', '35.000,00'),
